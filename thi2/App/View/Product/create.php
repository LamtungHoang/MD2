    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="type" class="form-control" name="sectors" id="inputPassword3">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Price</label>
                <div class="col-sm-10">
                    <input type="type" class="form-control" name="price" id="inputPassword3">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Amount</label>
                <div class="col-sm-10">
                    <input type="type" class="form-control" name="amount" id="inputPassword3">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="type" class="form-control" name="description" id="inputPassword3">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
